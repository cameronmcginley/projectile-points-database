...
export type GetPointByNameQuery = {
  __typename?: "Query";
  point?: {
    __typename?: "Point";
    name: string;
    ...
    phase: Array<string>;
    glacial_period: Array<string>;
    cultural_period: Array<string>;
    description?: string | null;
    aka: Array<string>;
    year_range_start?: number | null;
    year_range_start_type?: string | null;
    year_range_end?: number | null;
    year_range_end_type?: string | null;
    namers: Array<string>;
...
export type CreatePointMutation = {
  ...
  createPoint?: {
    ...
    year_range_end?: number | null;
    year_range_end_type?: string | null;
    short_for?: string | null;
    aka: Array<string>;
    point_validity?: string | null;
    description?: string | null;
  } | null;
};
...
export function getSdk(
  ...
  return {
    getPointByName(
      variables: GetPointByNameQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetPointByNameQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPointByNameQuery>(
            GetPointByNameDocument,
            variables,
    ...
    createPoint(
      variables: CreatePointMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<CreatePointMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreatePointMutation>(CreatePointDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "createPoint",
    ...
    deletePoint(
      variables: DeletePointMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<DeletePointMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeletePointMutation>(DeletePointDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "deletePoint",
    ...
    getPoints(
      variables?: GetPointsQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetPointsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPointsQuery>(GetPointsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getPoints",
