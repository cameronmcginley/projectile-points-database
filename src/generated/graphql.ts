...
export type GetPointByNameQuery = {
  ...
  point?: {
    ...
    phase?: string | null;
    glacial_period?: string | null;
    cultural_period?: string | null;
...
export function getSdk(
  ...
  return {
    getCourseByID(
      variables: GetCourseByIdQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetCourseByIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCourseByIdQuery>(GetCourseByIdDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getCourseByID",
    ...
    createCourse(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateCourseMutation>(
