...
export type DeletePointMutation = { __typename?: 'Mutation', deletePoint: boolean };
...
export type UpdatePointMutation = { __typename?: 'Mutation', updatePoint?: { __typename?: 'Point', name_id: string, name: string, shape: Array<string>, size: Array<string>, namers: Array<string>, named_for?: string | null, year_identified?: number | null, type_site?: string | null, glacial_period: Array<string>, cultural_period: Array<string>, year_range_start?: number | null, year_range_start_type?: string | null, year_range_end?: number | null, year_range_end_type?: string | null, short_for?: string | null, aka: Array<string>, point_validity?: string | null, description?: string | null } | null };
...
export const UpdatePointDocument = gql`
    mutation updatePoint($name_id: String!, $name: String!, $shape: [String!]!, $size: [String!]!, $namers: [String!]!, $named_for: String, $year_identified: Float, $type_site: String, $glacial_period: [String!]!, $cultural_period: [String!]!, $year_range_start: Float, $year_range_start_type: String, $year_range_end: Float, $year_range_end_type: String, $short_for: String, $aka: [String!]!, $point_validity: String, $description: String) {
  updatePoint(
    data: {name_id: $name_id, name: $name, shape: $shape, size: $size, namers: $namers, named_for: $named_for, year_identified: $year_identified, type_site: $type_site, glacial_period: $glacial_period, cultural_period: $cultural_period, year_range_start: $year_range_start, year_range_start_type: $year_range_start_type, year_range_end: $year_range_end, year_range_end_type: $year_range_end_type, short_for: $short_for, aka: $aka, point_validity: $point_validity, description: $description}
  ) {
    name_id
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    updatePoint(variables: UpdatePointMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdatePointMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdatePointMutation>(UpdatePointDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updatePoint', 'mutation');
    },
